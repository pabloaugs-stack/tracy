...
export default async function CatalogoPage({
  ...
  searchParams: Promise<{ aviso?: string; ok?: string }>
}) {
  ...
  return (
    <div>
      ...
      {/* Produtos saíram do Catálogo — agora ficam em Estoque. */}
      <p className="mb-6 text-xs text-tracy-muted bg-tracy-surface border border-tracy-border rounded-lg px-4 py-2.5">
        Produtos agora estão em{' '}
        <Link href="/admin/estoque?tab=produtos" className="text-tracy-gold hover:underline">Estoque → Produtos</Link>.
      </p>
